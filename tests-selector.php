...
<html lang="ro">
    ...
    <body id="page" onload="scrollToTop()">
        ...
        <div id="gallery" class="container">
            <img alt="" src="images/tests-selector/image1.jpg">
            <img alt="" src="images/tests-selector/image2.jpg">
            <img alt="" src="images/tests-selector/image3.jpg">
        </div>
        ...
        <div id="random-test" class="container body-wrapper">
            ...
            <p>Aici gasiti gratuit chestionare auto DRPCIV 2020 online, teste si intrebari, legate de Legislatia
                Rutiera,
                pentru categoriile B, simuland pe calculator chestionarul auto drpciv de la examen. Chestionarele auto
                de pe
                site-ul chestionare-az.ro sunt actualizate periodic si sunt conforme legislatiei in vigoare.</p>
            <p>Aici puteti sa va testati cunostintele cu o serie de chestionare pe diverse nivele, dar si cu intrebari
                total
                random</p>
